...
因此没有接入外部自瞄时也能使用鼠标手动瞄准并按左键射击；启用外部自瞄后，仍然不会绕过操作手扳机和自瞄 `fire=true` 门控。
...
默认四装甲靶车按照 RoboMaster AM02 小装甲模块建模：完整模块名义外形为 **140 × 125 mm**，主受击板为 **135 × 125 mm**，两侧指示灯导光件约为 **12 × 59 mm**，内部发光核心宽 **7 mm**，装甲正面相对竖直方向朝上偏转 **15°**。这些尺寸来自官方产品参数、安装规范和 AM02 STEP 模型。

尺寸依据：[RoboMaster AM02 2020 产品与官方 STEP 下载页](https://www.robomaster.com/zh-CN/products/components/detail/2600)、[RoboMaster 2025 机器人制作规范发布页](https://www.robomaster.com/zh-CN/resource/pages/announcement/1768)。

不同赛季、机器人结构和视觉算法常用的 PnP 特征尺寸可能不同。如果需要和你的机器人一致，请在 TOML 配置中修改模块外形、主受击板、灯条以及前后/左右安装半径。
